...
function Mode.source_items(Item)
  return {
    ...
    Item.blank(),
    Item.item("chop_attack", "ATK", {lockable = true, env_role = "attack", min = 0.0002, max = 0.5, step = 0.0005, snaps = {0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5}}),
    Item.item("chop_release", "REL", {lockable = true, env_role = "release", min = 0.0002, max = 0.5, step = 0.0005, snaps = {0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5}}),
    Item.blank()
  }
end
