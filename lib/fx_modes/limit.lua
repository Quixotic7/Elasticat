...
function Mode.source_items(Item, prefix)
  prefix = prefix or ""
  -- GAIN snaps 0/+3/+6/+9/+12/+18 dB (knob = dB/18*127); CEIL snaps -3/-1/-0.3/0
  -- dB (knob = (dB+6)/6*127).
  return {
    Item.item(prefix .. "limit_gain", "GAIN", {lockable = true, min = 0, max = 127, step = 1, snaps = {0, 21, 42, 64, 85, 127}}),
    Item.item(prefix .. "limit_ceil", "CEIL", {lockable = true, min = 0, max = 127, step = 1, snaps = {64, 106, 121, 127}}),
